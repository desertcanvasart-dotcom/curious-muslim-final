        ...
        <div className="container-custom py-16 relative z-10 w-full">
          ...
          >
            ...
            <p className="text-xl text-white leading-relaxed">
              We create stories that help children fall in love with their faith through
              warmth, honesty, and thoughtful conversations.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                <p>
                  As Muslim parents raising children in the West, we saw a gap. Our kids
                  were surrounded by engaging content about everything <em>except</em>
                  their own faith and heritage.
                </p>

                <p>
                  Many Islamic books felt distant from the world our children live in.
                  We wanted something warm and honest that would make them
                  <strong> excited</strong> to learn about Prophet Muhammad because
                ...
                <p>
                  ...
                  and feel respected for their curiosity.
                </p>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[#3D5A6C] font-medium italic">
                      &quot;We didn&apos;t want children to learn Islam because they had to
            ...
            {[
              {
                ...
                title: "Love First",
                description:
                  "Children learn best when they feel safe and loved. We lead with warmth--not fear--so faith becomes a source of comfort and confidence.",
                color: "#F2C94C",
              },
              {
                ...
                description:
                  "Every story is rooted in Islamic tradition, thoughtfully told in a way children can understand and connect with.",
                color: "#5C7A4B",
              },
              {
                ...
                description:
                  "Muslim children deserve to see themselves reflected positively and respectfully in the stories they grow up with.",
                color: "#3D5A6C",
              },
              {
                ...
                description:
                  "We welcome curiosity. Questions are not a weakness--they&apos;re a sign of growing faith and understanding.",
                color: "#6A8E9E",
              },
            ].map((value, index) => (
              <motion.div
      ...
      <section className="section-padding bg-gradient-to-br from-[#F5EFD4] to-white">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Curious Muslim is built by a small team of Muslim parents, educators, and
              creatives who care deeply about how children experience their faith.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                emoji: "✍️",
                description:
                  "Written with care by Muslim writers and parents who want children to feel seen and inspired.",
                color: "#3D5A6C",
              },
              {
                role: "Art & Design",
                emoji: "🎨",
                description:
                  "Illustrations crafted to feel warm, respectful, and full of wonder for young readers.",
                color: "#5C7A4B",
              },
              {
                ...
                emoji: "📖",
                description:
                  "Reviewed with care to ensure stories are accurate, age-appropriate, and spiritually nurturing.",
                color: "#6A8E9E",
              },
            ].map((member, index) => (
              <motion.div
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                <p>
                  Every family who joins Curious Muslim helps shape something bigger
                  than a book--a gentler way for children to grow up connected to
                  their faith.
                </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Whether you&apos;re a parent, teacher, or caregiver, we&apos;d love to have
              you with us as we nurture the next generation of curious, confident
              Muslims.
            </p>
