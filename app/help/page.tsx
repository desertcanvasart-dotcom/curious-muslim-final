...
const helpCategories = [
  {
    ...
    articles: [
      { title: "What is Curious Muslim?", href: "/about" },
      { title: "Who is the book for?", href: "/faq" },
      { title: "Meet the characters", href: "/characters" },
      { title: "How to pre-order", href: "/book" },
    ],
  },
  {
    id: "orders-shipping",
    ...
    articles: [
      { title: "How long does shipping take?", href: "/faq" },
      { title: "Do you ship internationally?", href: "/faq" },
      { title: "Bulk orders for schools", href: "/contact" },
      { title: "Track my order", href: "/contact" },
    ],
  },
  {
    id: "payments",
    ...
    articles: [
      { title: "Accepted payment methods", href: "/faq" },
      { title: "Refund policy", href: "/terms" },
      { title: "Request an invoice", href: "/contact" },
      { title: "Payment security", href: "/privacy" },
    ],
  },
  {
    id: "ask-noor",
    ...
    articles: [
      { title: "What is Ask Noor?", href: "/faq" },
      { title: "Is it safe for children?", href: "/faq" },
      { title: "How accurate are the answers?", href: "/faq" },
      { title: "Try Ask Noor", href: "/ask-noor" },
    ],
  },
  {
    id: "account",
    ...
    articles: [
      ...
      { title: "Update email preferences", href: "/contact" },
      { title: "Unsubscribe from emails", href: "/contact" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "Copyright information", href: "/terms" },
    ],
  },
];

const popularArticles = [
  { title: "What age is the book suitable for?", href: "/faq" },
  { title: "When will the book be released?", href: "/book" },
  { title: "Do you ship to my country?", href: "/faq" },
  { title: "Is Ask Noor safe for my child?", href: "/faq" },
  { title: "How can I contact you?", href: "/contact" },
];
